...
pip install torch torchvision torchaudio xformers --upgrade --index-url https://download.pytorch.org/whl/cu124
```
...
print("FLUX is locked, loaded, and isolated on GPU 0!")
