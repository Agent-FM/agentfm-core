...
export function ConfirmDispatchDialog({ sideEffect, onConfirm, onCancel }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onCancel}>
      <div className="glass-strong rounded-card p-5 max-w-md mx-4" role="dialog" aria-modal="true" aria-labelledby="confirm-dispatch-title" onClick={(e) => e.stopPropagation()}>
